...
<div class="container my-5">
    <div class="row justify-content-center">
        <!-- Menggunakan sistem Grid Bootstrap agar lebih responsif di HP/Tablet -->
            ...
            <div class="card border-0 shadow-lg rounded-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        @if (!empty($produk->foto))
                            <div class="col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center gap-3 p-2 border rounded-3 bg-light">
                                    <img src="{{ asset('storage/' . $produk->foto) }}" alt="Foto Produk" width="80" height="80" class="rounded-3 object-fit-cover border">
                        ...
                        <!-- Input Upload File -->
                        <div class="{{ !empty($produk->foto) ? 'col-12 col-md-6' : 'col-12' }}">
                            ...
                            <div id="preview-container" class="mt-3" style="display: none;">
                                ...
                                <div>
                                    <img id="preview" src="" class="rounded-3 border shadow-sm object-fit-cover" width="80" height="80">
                                </div>
                            </div>
                        </div>
                    </div>
